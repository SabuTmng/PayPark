...
class MemberManager:
    ...
    def registerMember(self, email, username, password, dateOfBirth, CITIZENSHIP_NO, address, phoneNo, employeeId):
        E1 = self.EmployeeMan.getEmployeeById(employeeId)
        member = Member(email, username, password, dateOfBirth, CITIZENSHIP_NO, address, phoneNo, E1)
