...
from .apiView import registerMemberApiView, deregisterMemberApiView, renewMembershipApiView, verifyCredentialsApiView, \
    memberDetailsApiView, getBillsDetailApiView, getUnpaidBillsDetailApiView, payBillApiView
from .apiView import registerEmployeeApiView, getAllParkingsDetailApiView
from .apiView import registerVehicleApiView, deregisterVehicleApiView, parkVehicleApiView, exitVehicleApiView, \
    getVehiclesDetailApiView, getParkedVehiclesDetailApiView
...
class EmployeeAccountApiCaller(AbsApiCaller):
    ...
    def getAllParkingsDetail(self):
        return getAllParkingsDetailApiView.as_view()
